from Gnomix.Smooth.smooth import Smoother

from Gnomix.Smooth.utils import slide_window

from xgboost import XGBClassifier
from Gnomix.Smooth.crf import CRF
...
class CNN_Smoother(Smoother):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from Gnomix.Smooth.cnn import CNN # This is to avoid requiring the installation of pytorch
